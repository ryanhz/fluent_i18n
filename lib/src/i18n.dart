...
class FluentLocalizations {
	...
	FluentLocalizations._internal(this.locale): bundle = FluentBundle(locale.toString());
	...
	factory FluentLocalizations.current() {
	...
	static FluentLocalizations of(BuildContext context) => Localizations.of<FluentLocalizations>(context, FluentLocalizations);

}


class FluentLocalizationsDelegate extends LocalizationsDelegate<FluentLocalizations> {
	...
	bool isSupported(Locale locale) {
		return supportLocales.map((locale) => locale.languageCode).contains(locale.languageCode);
	}
